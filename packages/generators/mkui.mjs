function mkui({ ui, code }) {
  return {
    ...
    'editorBracketHighlight.foreground1': `${ui.terminal.bright.magenta.hex()}AA`,
    'editorBracketHighlight.foreground2': `${ui.terminal.bright.red.hex()}AA`,
    'editorBracketHighlight.foreground3': `${ui.terminal.bright.yellow.hex()}AA`,
    'editorBracketHighlight.foreground4': `${ui.terminal.bright.cyan.hex()}AA`,
    'editorBracketHighlight.foreground5': `${ui.terminal.bright.green.hex()}AA`,
    'editorBracketHighlight.foreground6': `${ui.terminal.bright.blue.hex()}AA`,
