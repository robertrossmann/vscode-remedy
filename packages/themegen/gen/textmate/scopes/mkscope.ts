 ...
 *
 * @param   prefixes  Array of scope prefixes to use
 * @return  A function whose input scopes will be prefixed with provided scopes
 */
function mkscope(prefixes: string[]) {
  return function prescope(scopes: string[]) {
    const result = []
