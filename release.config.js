  ...
  plugins: [
    ...
    ['@semantic-release/github', {
      assets: [
        ...
        { path: 'resources/iTerm2/Remedy - Dark.itermcolors', label: 'Remedy - Dark.itermcolors' },
        { path: 'resources/iTerm2/Remedy - Bright.itermcolors', label: 'Remedy - Bright.itermcolors' },
      ],
    }],
  ],
}
