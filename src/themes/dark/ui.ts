...
const text = {
  ...
  secondary: palette.foreground.darken(0.6).desaturate(0.7),
  dimmed: palette.foreground.darken(0.6).desaturate(0.8),
  contrast: palette.base.darken(0.8),
  complimentary: palette.bright.yellow.darken(0.9).desaturate(0.3),
}

const background = {
  code: palette.base.lighten(0.2).desaturate(0.1),
  panel: palette.base,
  drop: text.primary,
  hover: palette.base.mix(text.primary, 0.15),
}

const border = background.panel.darken(0.2)
const shadow = palette.base.darken(0.5)
